...
public class Costumes extends AppCompatActivity {
    ...
    static String[] listNames = { "1", "2", "3", "4", "5", "6", "7", "8" };

    static Float[] listPrices = { (float) 600, (float) 400, (float) 300,(float) 1000, (float) 700, (float) 400, (float) 460,
            (float) 240};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView parent, View v,
                ...
                Intent i = new Intent(Costumes.this, AfficherPhotoCos.class);
