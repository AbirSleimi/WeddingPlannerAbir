...
public class Jus extends AppCompatActivity {
    ...
    static String[] listNames = { "cocktail", "Coffee", "Coffee black", "IceCream"};

    static Float[] listPrices = { (float) 1.600, (float) 1.400, (float) 1.300,(float) 2.000};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView parent, View v,
                ...
                Intent i = new Intent(Jus.this, AfficherPhotoJus.class);
                i.putExtra("positionJ", str);
                startActivity(i);
            }
        });
